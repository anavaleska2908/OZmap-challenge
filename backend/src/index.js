...
//   .use(jwt({secret: process.env.SECRET_KEY}).unless({path: [/\/register/, /\/login/, /\/users/]}))
   .use(router.routes());
       ...
       /*Deixei essa estrutura do middleware do koa para jwt, 
    para que possam me dar um feedback onde eu estava errando. 
    Quando eu acionava ele, o teste de servidor online quebrava.
    Desde já agradeço!*/
